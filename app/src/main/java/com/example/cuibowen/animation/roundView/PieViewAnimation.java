...
class PieViewAnimation extends Animation {
    private ArcConfig mViewConfig;
    private AnimationHandler mHandler;

    public PieViewAnimation(ArcConfig viewConfig) {
    ...
    protected void applyTransformation(float interpolatedTime, Transformation t) {
        ...
        if (interpolatedTime >= 0.0f && interpolatedTime <= 1.0f) {
            ...
            float angle = 360 * interpolatedTime + -90;


            PieInfo info = mViewConfig.findPieinfoWithAngle(angle);
    ...
    public interface AnimationHandler {
        void onAnimationProcessing(float angle, @NonNull PieInfo infoImpl);
    }
}
